...
public class AdmissionCommiteeMemberModel {
	...
	public String toString() {
		return String.format(
				"AdmissionCommiteeMemberModel [adminId=%s, adminName=%s, adminContact=%s, admissionResult=%s, admissionCommiteeLogin=%s]",
				adminId, adminName, adminContact, admissionResult, admissionCommiteeLogin);
	}
