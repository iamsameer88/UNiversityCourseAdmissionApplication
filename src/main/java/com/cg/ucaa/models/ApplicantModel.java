...
public class ApplicantModel {
	...
	public AdmissionModel getAdmission() {
		return admission;
	}

	public void setAdmission(AdmissionModel admission) {
	...
	public String toString() {
		return String.format(
				"ApplicantModel [applicantId=%s, applicantName=%s, mobileNumber=%s, applicantDegree=%s, applicantGradPercent=%s, admission=%s]",
				applicantId, applicantName, mobileNumber, applicantDegree, applicantGradPercent, admission);
	}
