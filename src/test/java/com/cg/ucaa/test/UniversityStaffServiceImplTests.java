...
@SpringBootTest
public class UniversityStaffServiceImplTests {
	...
	public void testAddUniversityStaff() throws UniversityStaffMemberNotFoundException {
	...
	/**
	 * Test Case 4 - updating staff members in the university
	 */
	@Test
	@DisplayName("UniversityStaffMemberImpl::updateUniversityStaff should return updated staff with provided staffId")
	public void testUpdateUniversityStaff() throws UniversityStaffMemberNotFoundException {
	...
	/**
	 * Test Case 5 - removing staff members in the university
	 */
	@Test
	@DisplayName("UniversityStaffMemberImpl::removeStaff should remove staff for given staffId")
	public void testRemoveStaff() throws UniversityStaffMemberNotFoundException {
		UniversityStaffMemberEntity testData = new UniversityStaffMemberEntity(1L, "dean@1234", "Full Stack Trainer");
	...
	/**
	 * Test Case 6 - providing null if staff member with specific id does not exists in the university
	 */
	@Test()
	...
	/**
	 * Test Case 7 - facilitating null if no staff members are present in the university
	 */
	@Test
